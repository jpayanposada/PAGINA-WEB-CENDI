...
<body>
    ...
    <div class="site-breadcrumb">
        <div class="container">
            ...
            <span>Técnico Laboral como Auxiliar Administrativo</span>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-12 post-list">
                    <div class="post-item">
                        ...
                        <br>
                        <div class="post-thumb set-bg" data-setbg="img/sliders/admin.png"></div>
                        <br>
                            ...
                            <div class="col-lg-12 about-text">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                        <div class="list-group" id="list-tab" role="tablist">
                                            ...
                                            <a class="list-group-item list-group-item-action" id="list-settings-list" data-toggle="list" href="#transversal" role="tab" aria-controls="settings">MÓDULOS OBLIGATORIOS</a>
                                        </div>
                                    </div>
                                        ...
                                        <div class="tab-content" id="nav-tabContent">
                                            <div class="tab-pane fade show active" id="egreso" role="tabpanel" aria-labelledby="list-home-list" style="text-align: justify;">
                                                ...
                                                <ul class="about-list">
                                                    ...
                                                    <br>
                                                    <br>
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Auxiliar Administrativo.
                                                </ul>
                                            ...
                                            <div class="tab-pane fade" id="plan" role="tabpanel" aria-labelledby="list-profile-list" style="text-align: justify;">
                                                ...
                                                <br>
                                                El programa Técnico Laboral como Auxiliar Administrativo, cuenta con un total de 1.200 horas, distribuidas en tres niveles de formación: 50% teórico (600 horas) y 50% prácticas (600 horas). Las horas prácticas serán de cumplimiento en las instituciones en que se tengan convenio.
                                            </div>
                                                ...
                                                <ul class="about-list">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                                            ...
                                                            <br>
                                                            <br>
                                                            <i class="fa fa-check-square-o" style="color: red;"></i> Economía Digital.
                                                            <br>
                                                            <br>
                        ...
                        <h5 style="text-align: center;">
                            ...
                            TÉCNICO LABORAL POR COMPETENCIAS COMO AUXILIAR ADMINISTRATIVO <br>
                            ...
                            <img src="img/logosCelac/celac-aux-admi.png" alt="celac" style="padding: 5px;" width="500px">
                        </h5>
                    </div>
