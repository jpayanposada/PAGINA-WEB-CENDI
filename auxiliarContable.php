...
<body>
    ...
    <div class="site-breadcrumb">
        <div class="container">
            ...
            <span>Técnico Laboral como Auxiliar Contable</span>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-12 post-list">
                    <div class="post-item">
                        ...
                        <br>
                        <div class="post-thumb set-bg" data-setbg="img/sliders/contador.png"></div>
                        <br>
                        <h5 style="text-align: center;">Lic. de Funcionamiento N° 05293 de Junio 25 de 2009<br>
                            Lic. de Funcionamiento N° 201750021377 de Diciembre 19 de 2017 Resolución de la Secretaria
                            de Educación: <br>N° 202150177931 DE 22/11/2021</h5>
                        <br>
                        <br>
                        <div class="row">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-12">
                                        <div class="tab-content" id="nav-tabContent">
                                            <div class="tab-pane fade show active" id="egreso" role="tabpanel" aria-labelledby="list-home-list" style="text-align: justify;">
                                                ...
                                                <br>
                                                Ocupaciones en las que el egresado puede desempeñarse:
                                                <br>
                                                <br>
                                                <ul class="about-list">
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Cajeros de
                                                    servicios financieros.
                                                    <br>
                                                    <br>

                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Auxiliar
                                                    del contador.
                                                    <br>
                                                    <br>
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Auxiliar de
                                                    revisoría Fiscal.
                                                    <br>
                                                    <br>
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Asistentes financieros.
                                                    <br>
                                                    <br>
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Auxiliares
                                            ...
                                            <div class="tab-pane fade" id="plan" role="tabpanel" aria-labelledby="list-profile-list" style="text-align: justify;">
                                                ...
                                                <br>
                                                El programa Técnico laboral como auxiliar contable, cuenta con un total
                                                de 1.200 horas, distribuidas en tres niveles de
                                                formación: 50% teórico (600 horas) y 50% prácticas (600 horas). Las
                                                horas prácticas serán de cumplimiento en las
                                                instituciones en que se tenga convenio.
                                            </div>
                                            ...
                                            <div class="tab-pane fade" id="basicos" role="tabpanel" aria-labelledby="list-settings-list" style="text-align: justify;">
                                                ...
                                                <br>
                                                <ul class="about-list">
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Desarrollo
                                                    humano.
                                                    <br>
                                                    <br>
