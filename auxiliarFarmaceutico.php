				...
				<div class="col-lg-12 post-list">
					<div class="post-item">
                                    ...
                                    <div class="col-8">
                                      <div class="tab-content" id="nav-tabContent">
                                        <div class="tab-pane fade show active" id="egreso" role="tabpanel" aria-labelledby="list-home-list" style="text-align: justify;">
                                            ...
                                            <br>
                                            <ul class="about-list">
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Auxiliar de farmacia.
                                                <br>
                                                <br>
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Auxiliar de droguería.
                                                <br>
                                                <br>
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Instituciones prestadoras de salud pública y privada.
                                                <br>
                                                <br>
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Comercio.
                                        ...
                                        <div class="tab-pane fade" id="plan" role="tabpanel" aria-labelledby="list-profile-list"style="text-align: justify;">
                                            ...
                                            <br>
                                            El programa Técnico laboral en servicios farmacéuticos, Cuenta con un total de 1.600 horas, distribuidas en tres niveles 
                                            de formación: 40% teórico (640) y 60% prácticas (960 horas). Las horas prácticas serán de cumplimiento en las instituciones 
                                            en que se tenga convenio.
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="especificos" role="tabpanel" aria-labelledby="list-settings-list"style="text-align: justify;">
                                            ...
                                            <br>
                                                <ul class="about-list">
                                                    ...
                                                    <br>
                                                    <br>
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Atención de primer respondiente.
                                                    <br>
                                                    <br>
						...
						<br>
                            ...
                            <img src="img/logosCelac/celac-aux-farmaceutico.png" style="padding: 5px;" alt="celac" width="500px">
                        </h5>
					</div>
