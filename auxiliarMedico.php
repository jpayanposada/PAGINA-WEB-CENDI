...
<body>
    ...
    <div class="site-breadcrumb">
        <div class="container">
            ...
            <span>Técnico laboral como secretaria (o) médica (o)</span>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 post-list">
                    <div class="post-item">
                        <h4>Técnico laboral como secretaria (o) médica (o)</h4>
                        <br>
                        <div class="post-thumb set-bg" data-setbg="img/sliders/secretaria.png"></div>
                        <br>
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-12">
                                        <div class="tab-content" id="nav-tabContent">
                                            <div class="tab-pane fade show active" id="egreso" role="tabpanel" aria-labelledby="list-home-list" style="text-align: justify;">
                                                ...
                                                <br>
                                                <ul class="about-list">
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Auxiliar de oﬁcina.
                                                    <br>
                                                    <br>
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Digitadores.
                                                    <br>
                                                    <br>
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Secretaria médica.
                                                    <br>
                                                    <br>
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Secretaria general.
                                                    <br>
                                                    <br>
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Secretaria de consultorios médicos.
                                            ...
                                            <div class="tab-pane fade" id="plan" role="tabpanel" aria-labelledby="list-profile-list" style="text-align: justify;">
                                                ...
                                                <br>
                                                El programa Técnico Laboral como Secretaria(o) Medica(o), cuenta con un total de 1.200 horas,
                                                ...
                                                <ul class="about-list">
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                                            ...
                                                            <br>
                                                            <br>
                                                            <i class="fa fa-check-square-o" style="color: red;"></i> Calidad en Salud.

                                                        </div>
                                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <i class="fa fa-check-square-o" style="color: red;"></i> Facturación.
                                                            <br>
                                                            <br>
                        ...
                        <h5 style="text-align: center;">
                            ...
                            TÉCNICO LABORAL POR COMPETENCIAS COMO SECRETARIA(O) MÉDICA(O) <br>
                            ...
                            <img src="img/logosCelac/celac-secretaria-medica.png" alt="celac" style="padding: 5px;" width="500px">
