...
<body>
    ...
    <div class="site-breadcrumb">
        <div class="container">
            ...
            <span>Técnico laboral como auxiliar en recursos humanos</span>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-12 post-list">
                    <div class="post-item">
                        ...
                        <br>
                        <div class="post-thumb set-bg" data-setbg="img/sliders/rhumanos.png"></div>
                        <br>
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-12">
                                        <div class="tab-content" id="nav-tabContent">
                                            <div class="tab-pane fade show active" id="egreso" role="tabpanel" aria-labelledby="list-home-list" style="text-align: justify;">
                                                ...
                                                <br>
                                                <ul class="about-list">
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Auxiliar de personal.
                                                    <br>
                                                    <br>
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Auxiliar de relaciones laborales.
                                                    <br>
                                                    <br>
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Auxiliar de selección de personal.
                                                    <br>
                                                    <br>
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Auxiliares de nómina y prestaciones.
                                            ...
                                            <div class="tab-pane fade" id="plan" role="tabpanel" aria-labelledby="list-profile-list" style="text-align: justify;">
                                                ...
                                                <br>
                                                El programa técnico laboral como auxiliar en recursos humanos, cuenta con un total de 1.200 horas,
                                                distribuidas en tres niveles de formación: 50% teórico (600 horas) y 50% prácticas (600 horas).
                                                Las horas prácticas serán de cumplimiento en las instituciones en que se tenga convenio.
                                            </div>
                                                ...
                                                <ul class="about-list">
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                                            ...
                                                            <br>
                                                            <br>
                                                            <i class="fa fa-check-square-o" style="color: red;"></i> Gestión Humana I.
                                                            <br>
                                                            <br>
                                                            <i class="fa fa-check-square-o" style="color: red;"></i> Seguridad Social.
                                                            <br>
                                                            <br>
                                                            <i class="fa fa-check-square-o" style="color: red;"></i> Gestión Humana II.
                                                            <br>
                                                            <br>
                                                            <i class="fa fa-check-square-o" style="color: red;"></i> Psicología Organizacional.
                                                            <br>
                                                            <br>
                                                            <i class="fa fa-check-square-o" style="color: red;"></i> Seguridad y Salud en el Trabajo.
                                                            <br>
                                                            <br>
                                                            <i class="fa fa-check-square-o" style="color: red;"></i> Perfiles de Cargos.
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                                            ...
                                                            <br>
                                                            <br>
                                                            <i class="fa fa-check-square-o" style="color: red;"></i> Negociación Y Conflicto Laboral.
                                                            <br>
                                                            <br>
                        ...
                        <h5 style="text-align: center;">
                            ...
                            TÉCNICO LABORAL POR COMPETENCIAS COMO AUXILIAR EN RECURSOS HUMANOS <br>
                            ...
                            <img src="img/logosCelac/celac-recurso-humanos.png" alt="celac" style="padding: 5px;" width="250px">
