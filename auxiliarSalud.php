				...
				<div class="col-lg-12 post-list">
					<div class="post-item">
                        ...
                        <h5 style="text-align: center;">Lic. de Funcionamiento N° 05293 de Junio 25 de 2009<br>
                            Lic. de Funcionamiento N° 201750021377 de Diciembre 19 de 2017 Resolución de la Secretaria de Educación: <br>N° 03382 del
                            13 marzo de 2014, Renovación 201950091777 del 20 de Septiembre de 2019
                            </h5>
                            <br>
                            <br>
                            <div class="row">
                                    ...
                                    <div class="col-8">
                                      <div class="tab-content" id="nav-tabContent">
                                        <div class="tab-pane fade show active" id="egreso" role="tabpanel" aria-labelledby="list-home-list" style="text-align: justify;">
                                            ...
                                            <br>
                                            <ul class="about-list">
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Auxiliar de ingreso y recaudo.
                                                <br>
                                                <br>
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Auxiliar de cuentas médicas.
                                                <br>
                                                <br>
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Auxiliar de cobranza y facturación.
                                                <br>
                                                <br>
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Promotor atención al usuario.
                                                <br>
                                                <br>
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Auxiliar administrativo en salud. 
                                            </ul>
                                        ...
                                        <div class="tab-pane fade" id="plan" role="tabpanel" aria-labelledby="list-profile-list"style="text-align: justify;">
                                            ...
                                            <br>
                                            El programa técnico laboral en administrativo en salud, cuenta con un total de 1.600 horas, distribuidas en tres 
                                            niveles de formación: 40% teórico (640 horas) y 60% prácticas (960 horas). Las horas prácticas serán de cumplimiento 
                                            en las instituciones en que se tenga convenio.
                                        </div>
						...
						<br>
                            ...
                            <img src="img/logosCelac/Logos-admi-salud.png" alt="celac" style="padding: 10px;" width="500px">
                        </h5>
					</div>
