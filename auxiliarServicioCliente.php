...
<body>
	...
	<div class="site-breadcrumb">
		<div class="container">
			...
			<span>Técnico Laboral como Auxiliar en Servicio al Cliente  y Telemercadeo</span>
		</div>
	</div>
			...
			<div class="row">
				<div class="col-lg-12 post-list">
					<div class="post-item">
                        ...
                        <br>
                        <div class="post-thumb set-bg" data-setbg="img/sliders/cliente.png"></div>
                        <br>
                        <h5 style="text-align: center;">Lic. de Funcionamiento N° 05293 de Junio 25 de 2009<br>
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-12">
                                      <div class="tab-content" id="nav-tabContent">
                                        <div class="tab-pane fade show active" id="egreso" role="tabpanel" aria-labelledby="list-home-list" style="text-align: justify;">
                                            ...
                                            <br>Ocupaciones en las que el egresado puede desempeñarse:
                                            <br>
                                            <br>
                                            <ul class="about-list">
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Recepcionistas y operadores de conmutador.
                                                <br>
                                                <br>
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Auxiliares de banca, seguros y otros servicios financieros.
                                                <br>
                                                <br>
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Auxiliares de publicación y aﬁnes.
                                                <br>
                                                <br>
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Vendedores de mostrador.
                                                <br>
                                                <br>
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Empleados de ventas y servicios de líneas aéreas, marítimas y terrestres.
                                                <br>
                                                <br>
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Asesor de servicio al cliente.
                                                <br>
                                                <br>
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Operador de call center y contac center.
                                                <br>
                                                <br>
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Gestor de tele cobranza.
                                                <br>
                                                <br>
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Atención al cliente interno y externo.
                                            </ul>
                                        ...
                                        <div class="tab-pane fade" id="plan" role="tabpanel" aria-labelledby="list-profile-list"style="text-align: justify;">
                                            ...
                                            <br>
                                            El programa técnico laboral como auxiliar en servicio al cliente y telemercadeo, cuenta con un total de 1.200 horas,
                                             distribuidas en tres niveles de formación: 50% teórico (600 horas) y 50% prácticas (600 horas). Las horas 
                                             prácticas serán de cumplimiento en las instituciones en que se tenga convenio.
                                        </div>
                                        <div class="tab-pane fade" id="duracion" role="tabpanel" aria-labelledby="list-messages-list"style="text-align: justify;">
                                            
                                         <h3>DURACIÓN: </h3>
                                         <br>
                                         <h3 style="color: red;">3 NIVELES</h3>
                                        ...
                                        <div class="tab-pane fade" id="basicos" role="tabpanel" aria-labelledby="list-settings-list"style="text-align: justify;">
                                            ...
                                            <br>
                                            <ul class="about-list">
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Desarrollo humano.
                                                <br>
                                                <br>
                         ...
                         <h5 style="text-align: center;">
                            ...
                            TÉCNICO LABORAL POR COMPETENCIAS COMO AUXILIAR EN SERVICIO AL CLIENTE Y TELEMERCADEO.<br>
