...
<body>
    ...
    <div class="site-breadcrumb">
        <div class="container">
            ...
            <span>Técnico laboral como auxiliar de sistemas informáticos</span>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-12 post-list">
                    <div class="post-item">
                        ...
                        <br>
                        <div class="post-thumb set-bg" data-setbg="img/sliders/sistemas.png"></div>
                        <br>
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-12">
                                        <div class="tab-content" id="nav-tabContent">
                                            <div class="tab-pane fade show active" id="egreso" role="tabpanel" aria-labelledby="list-home-list" style="text-align: justify;">
                                                ...
                                                <br>
                                                <ul class="about-list">
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Técnicos en operaciones de tecnología de la información y las comunicaciones.
                                                    <br>
                                                    <br>
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Técnicos en asistencia y soporte al usuario de tecnología de la información y las comunicaciones.
                                                    <br>
                                                    <br>
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Técnicos en redes y sistemas de computación.
                                                    <br>
                                                    <br>
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Técnicos de la Web.
                                            ...
                                            <div class="tab-pane fade" id="plan" role="tabpanel" aria-labelledby="list-profile-list" style="text-align: justify;">
                                                ...
                                                <br>
                                                El programa técnico laboral como auxiliar de sistemas informáticos, cuenta con un total de 1.200 horas, distribuidas en tres
                                                niveles de formación: 50% teórico (600 horas) y 50% prácticas (600 horas). Las horas prácticas
                                                serán de cumplimiento en las instituciones en que se tenga convenio.
                                            </div>
                        ...
                        <h5 style="text-align: center;">
                            ...
                            TÉCNICO LABORAL POR COMPETENCIAS COMO AUXILIAR DE SISTEMAS. <br>
