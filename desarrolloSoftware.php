...
<body>
	...
	<div class="site-breadcrumb">
		<div class="container">
			...
			<span>Técnico Laboral como Asistente en Desarrollo de Software</span>
		</div>
	</div>
			...
			<div class="row">
				<div class="col-lg-12 post-list">
					<div class="post-item">
                        ...
                        <br>
                        <div class="post-thumb set-bg" data-setbg="img/sliders/software.png"></div>
                        <br>
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-12">
                                      <div class="tab-content" id="nav-tabContent">
                                        <div class="tab-pane fade show active" id="egreso" role="tabpanel" aria-labelledby="list-home-list" style="text-align: justify;">
                                            ...
                                            <br>
                                            <ul class="about-list">
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Asistente en análisis y desarrollo de sistemas de información.
                                                <br>
                                                <br>
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Asistente en análisis y desarrollo de software.
                                                <br>
                                                <br>
                                        ...
                                        <div class="tab-pane fade" id="obligatorios" role="tabpanel" aria-labelledby="list-settings-list"style="text-align: justify;">
                                            ...
                                            <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                                            ...
                                                            <i class="fa fa-check-square-o" style="color: red;"></i> Levantar Requisitos de la solución de software.
                                                            <br>
                                                            <br>
						...
						<br>
                            ...
                            <img src="img/logosCelac/celac-desarrollo-software.png" alt="celac" style="padding: 5px;" width="500px">
