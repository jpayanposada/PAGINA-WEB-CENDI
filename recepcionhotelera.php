...
<body>
	...
	<div class="site-breadcrumb">
		<div class="container">
			...
			<span>Técnico Laboral como Empleado de Recepción Hotelera</span>
		</div>
	</div>
                                    ...
                                    <div class="col-8">
                                      <div class="tab-content" id="nav-tabContent">
                                        <div class="tab-pane fade show active" id="egreso" role="tabpanel" aria-labelledby="list-home-list" style="text-align: justify;">
                                            ...
                                            <br>
                                            <ul class="about-list">
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Agentes de Viajes.
                                                <br>
                                                <br>
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Auxiliares de Servicios a Viajeros.
                                                <br>
                                                <br>
                                                <i class="fa fa-check-square-o" style="color: red;"></i> Empleados de Recepción Hotelera.
                                             </ul>
                                        ...
                                        <div class="tab-pane fade" id="plan" role="tabpanel" aria-labelledby="list-profile-list"style="text-align: justify;">
                                            ...
                                            <br>
                                            <p>El programa Técnico laboral como Empleado de Recepción Hotelera, cuenta con un total de 1.200 horas, distribuidas en tres niveles de formación: 50% teórico (600 horas) y 50% prácticas (600 horas). Las horas prácticas serán de cumplimiento en las instituciones en que se tenga convenio.</p>
                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="obligatorios" role="tabpanel" aria-labelledby="list-settings-list"style="text-align: justify;">
                                            ...
                                            <br>
                                                <ul class="about-list">
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Tic's
                                                    <br>
                                                    <br>
                                                    ...
                                                    <br>
                                                    <br>
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Eventos.
                                                    <br>
                                                    <br>
                                                    ...
                                                    <br>
                                                    <br>
                                                    <i class="fa fa-check-square-o" style="color: red;"></i> Asesorías de Práctica.
                                                    <br>
                                                    <br>
